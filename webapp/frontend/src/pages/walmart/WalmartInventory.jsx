...
const STORE_DETAIL_COLS = [
  ...
  { key: "onOrderZeroOH",  label: "On Order → 0-OH Strs",       color: (v) => v > 0 ? "#f59e0b" : "var(--txt3)",                  title: "Total on-order (in-transit + in-warehouse) for stores with 0 OH — store-level aggregate" },
  { key: "storesOneUnit",  label: "Stores 1 Unit OH",           color: (v) => v > 0 ? COLORS.red : "var(--txt3)",                  title: "Stores with exactly 1 unit on hand — store-level aggregate from walmart_store_weekly" },
